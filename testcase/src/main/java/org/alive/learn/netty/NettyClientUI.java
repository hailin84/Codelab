...
public class NettyClientUI extends JFrame {
	...
	/** 是否添加消息长度到消息头部选项 */
	public static final String[] LENGTH_OPTIONS = new String[] { "17字节消息头部" };
	...
	private void initialize() {
		...
		this.setTitle("Netty长连接客户端 - V1.0 By myumen Build.20170927");
		...
		this.lengthCombo.setToolTipText("也可以直接输入消息头部长度，默认为17字节");
	...
	private void addListeners() {
		...
		this.connectOrDisconnect.addActionListener(new ActionListener() {
			...
			private void connect(ActionEvent e) {
				...
				helper.connect(); // 连接成功通过UIUpdater更新界面组件
			}
